...
public class EclInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected EclRuntimeModule createRuntimeModule() {
		...
		return new EclRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return EclInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
