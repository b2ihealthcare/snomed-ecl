...
public class EclParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EclGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTypedTermFilterClauseAccess().getGroup(), "rule__TypedTermFilterClause__Group__0");
			...
			builder.put(grammarAccess.getSemanticTagFilterAccess().getGroup_0(), "rule__SemanticTagFilter__Group_0__0");
			builder.put(grammarAccess.getEffectiveTimeFilterAccess().getGroup(), "rule__EffectiveTimeFilter__Group__0");
			builder.put(grammarAccess.getEffectiveTimeFilterAccess().getGroup_0(), "rule__EffectiveTimeFilter__Group_0__0");
			...
			builder.put(grammarAccess.getTypedTermFilterClauseAccess().getLexicalSearchTypeAssignment_0_0(), "rule__TypedTermFilterClause__LexicalSearchTypeAssignment_0_0");
			builder.put(grammarAccess.getTypedTermFilterClauseAccess().getTermAssignment_1(), "rule__TypedTermFilterClause__TermAssignment_1");
			...
			builder.put(grammarAccess.getSemanticTagFilterAccess().getDomainAssignment_0_0(), "rule__SemanticTagFilter__DomainAssignment_0_0");
			builder.put(grammarAccess.getSemanticTagFilterAccess().getOpAssignment_2(), "rule__SemanticTagFilter__OpAssignment_2");
			builder.put(grammarAccess.getSemanticTagFilterAccess().getSemanticTagAssignment_3(), "rule__SemanticTagFilter__SemanticTagAssignment_3");
			builder.put(grammarAccess.getEffectiveTimeFilterAccess().getDomainAssignment_0_0(), "rule__EffectiveTimeFilter__DomainAssignment_0_0");
			builder.put(grammarAccess.getEffectiveTimeFilterAccess().getOpAssignment_2(), "rule__EffectiveTimeFilter__OpAssignment_2");
			builder.put(grammarAccess.getEffectiveTimeFilterAccess().getEffectiveTimeAssignment_3(), "rule__EffectiveTimeFilter__EffectiveTimeAssignment_3");
