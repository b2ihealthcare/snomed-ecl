...
public class EclStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new EclRuntimeModule());
	}
	
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.b2international.com/snomed/Ecl")) {
			EPackage.Registry.INSTANCE.put("http://www.b2international.com/snomed/Ecl", EclPackage.eINSTANCE);
		}
