 ...
 * </p>
 * <ul>
 *   <li>{@link com.b2international.snomed.ecl.ecl.impl.AcceptableInFilterImpl#getLanguageRefSetId <em>Language Ref Set Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AcceptableInFilterImpl extends PropertyFilterImpl implements AcceptableInFilter
{
  /**
  ...
  {
    return EclPackage.Literals.ACCEPTABLE_IN_FILTER;
  }
  ...
  public NotificationChain basicSetLanguageRefSetId(FilterValue newLanguageRefSetId, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EclPackage.ACCEPTABLE_IN_FILTER__LANGUAGE_REF_SET_ID, oldLanguageRefSetId, newLanguageRefSetId);
  ...
  public void setLanguageRefSetId(FilterValue newLanguageRefSetId)
  {
    if (newLanguageRefSetId != languageRefSetId)
    {
      ...
      if (languageRefSetId != null)
        msgs = ((InternalEObject)languageRefSetId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EclPackage.ACCEPTABLE_IN_FILTER__LANGUAGE_REF_SET_ID, null, msgs);
      if (newLanguageRefSetId != null)
        msgs = ((InternalEObject)newLanguageRefSetId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EclPackage.ACCEPTABLE_IN_FILTER__LANGUAGE_REF_SET_ID, null, msgs);
      msgs = basicSetLanguageRefSetId(newLanguageRefSetId, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EclPackage.ACCEPTABLE_IN_FILTER__LANGUAGE_REF_SET_ID, newLanguageRefSetId, newLanguageRefSetId));
  }
