 ...
 * </p>
 * <ul>
 *   <li>{@link com.b2international.snomed.ecl.ecl.impl.NestedFilterImpl#getNested <em>Nested</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NestedFilterImpl extends PropertyFilterImpl implements NestedFilter
{
  ...
  {
    return EclPackage.Literals.NESTED_FILTER;
  }
  ...
  public NotificationChain basicSetNested(Filter newNested, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EclPackage.NESTED_FILTER__NESTED, oldNested, newNested);
  ...
  public void setNested(Filter newNested)
  {
    if (newNested != nested)
    {
      ...
      if (nested != null)
        msgs = ((InternalEObject)nested).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EclPackage.NESTED_FILTER__NESTED, null, msgs);
      if (newNested != null)
        msgs = ((InternalEObject)newNested).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EclPackage.NESTED_FILTER__NESTED, null, msgs);
      msgs = basicSetNested(newNested, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EclPackage.NESTED_FILTER__NESTED, newNested, newNested));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EclPackage.NESTED_FILTER__NESTED:
