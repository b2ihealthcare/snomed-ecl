 ...
 * </p>
 * <ul>
 *   <li>{@link com.b2international.snomed.ecl.ecl.ActiveFilter#getOp <em>Op</em>}</li>
...
public interface ActiveFilter extends PropertyFilter
{
   ...
   * @see #setOp(String)
   * @see com.b2international.snomed.ecl.ecl.EclPackage#getActiveFilter_Op()
   * @model
   * @generated
   */
  String getOp();
  ...
  /**
   * Sets the value of the '{@link com.b2international.snomed.ecl.ecl.ActiveFilter#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
